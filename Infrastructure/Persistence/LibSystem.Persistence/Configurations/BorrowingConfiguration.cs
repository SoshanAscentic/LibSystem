...
public class BorrowingConfiguration : IEntityTypeConfiguration<BorrowingRecord>
{
    public void Configure(EntityTypeBuilder<BorrowingRecord> builder)
    {
        ...
        // BorrowingId will be a computed property that always returns the database Id
        builder.Ignore(br => br.BorrowingId);

        // Foreign Keys - reference the domain ID values
        ...
        // Unique constraint for active borrowings (prevents duplicate active loans)
